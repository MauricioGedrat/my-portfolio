      ...
      <div className="flex justify-center items-center">
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-20">
          <div data-aos='flip-down' data-aos-duration={2000} className="md:flex-row flex-col flex justify-center items-center gap-14">
            ...
            <div className="relative  flex items-center md:w-96 w-60 text-xl border-4 rounded-full h-10 border-blue-500 text-white ">
          ...
          <div data-aos='flip-down' data-aos-duration={2000} className="md:flex-row flex-col flex justify-center items-center gap-14">
            <NodeSvg />
            <div className="relative  flex items-center md:w-96 w-60 text-sm  sm:text-xl border-4 rounded-full h-10 border-blue-500 text-white ">
