    ...
    <div data-aos="fade-up" className="fixed w-full z-[1000]">
      ...
      <div className="rounded-xl relative flex md:hidden justify-between items-center z-[99] bg-transparent px-10 backdrop-blur-lg">
        ...
        <button className="text-white p-5" onClick={() => setShow(!show)}>
          ...
          <div className="w-10 h-[2px] bg-white mt-3"></div>
        </button>
      </div>
      {show && (
        <div
          data-aos="fade-up"
          className=" absolute md:hidden block top-0 bottom-0 left-0 right-0 bg-transparent backdrop-blur-2xl h-screen z-[99]"
        >
          <button
            className="relative text-white font-['Poppins'] p-5 text-4xl"
